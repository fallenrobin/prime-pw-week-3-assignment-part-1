...
let favoriteFoods = ['italian', 'thai', 'banh mi', 'tacos', 'cheese', 'fruit']

// 1.b. TODO: Log your array of foods to the console with a message, similar
//      to the example above
console.log('Favorite foods include:', favoriteFoods);
...
console.log('The last animal is:', animalArray[4-1]);
...
favoriteFoods.push('caesar salad');
console.log('Added another food to list,', favoriteFoods);
...
favoriteFoods.unshift('lox and cream cheese bagel');
